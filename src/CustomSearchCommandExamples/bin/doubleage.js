...
/******************************************************************************
*	doubleage.js	Splunk Example Custom Search Command
*
*	doubles the value in the 'age' field for all events
*	this is a streaming command (distributed)
*
...
const getinfo_reply = function(){
	...
	try {
		jsonReply = JSON.stringify({
			type 			: 'streaming',		// default is streaming (or stateful, events, reporting)
